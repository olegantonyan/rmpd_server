...
ActiveRecord::Schema.define(version: 2019_02_26_050355) do
  ...
  create_table "device_statuses", id: :serial, force: :cascade do |t|
  ...
  create_table "media_items", id: :serial, force: :cascade do |t|
    ...
    t.index ["file"], name: "index_media_items_on_file"
