...
gem 'rufus-scheduler'
gem 'daemons'
gem 'will_paginate', github: 'olegantonyan/will_paginate', branch: 'rails5'
...
gem 'sidekiq'
gem 'sinatra', '>= 2.0.0.beta2', require: false #github: 'sinatra/sinatra', ref: '88a1ba7bfb2262b68391d2490dbb440184b9f838'
